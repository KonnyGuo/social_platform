...
```
Make sure you have a mongoDB atlas account. Inside configs folder. Create new file called .env and set MONGO_URI = <yourMongoDBConnection> (you need to set this up with your Mongo altas cluster connection).
...
<img src="public/imgs/login_homePage.png" alt="login" width="700" style="display: inline-block;">

=<img src="public/imgs/commentAndLikes.png" width="700" style="display: inline-block;">
